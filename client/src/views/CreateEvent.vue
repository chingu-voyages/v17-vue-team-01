  ...
  methods: {
    ...
    processFormFirst() {
      ...
      if (d1.getTime() > d2.getTime()) {
        ...
        this.axios
            .post("https://chingutime.herokuapp.com/api/events/create" || `${process.env.VUE_APP_BE_URL}/events/create`,{
    ...
    processFormSecond() {
      ...
      this.axios
          .post("https://chingutime.herokuapp.com/api/timeslots/create" || `${process.env.VUE_APP_BE_URL}/timeslots/create`,{
